...
def get_attractions_for_traveler():
  ...
  interests_string = "Hi " + name + ", we think you'll like these places around " + traveler_destination + ": \n"

  count = 1
  for attraction in traveler_attractions:
    interests_string += str(count) + ". " + attraction
    count+=1
...
def create_traveler():
  ...
  return [name, destination, [interests]]
